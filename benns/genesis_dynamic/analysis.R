...
latency  <-  ggplot(combined_data, aes(x = generation, y = average_latency)) +
    ...
    geom_text(aes(x = 1, label = "\n14 Hosts", y = 50), colour = "#955196", angle = 90, family = "Times New Roman") +
    ...
    geom_text(aes(x = segment_5_last_gen, label = "\n13 Hosts", y = 50), colour = "#955196", angle = 90, family = "Times New Roman") +
    geom_text(aes(x = segment_6_last_gen, label = "\n12 Hosts", y = 50), colour = "#955196", angle = 90, family = "Times New Roman") +
    geom_text(aes(x = segment_7_last_gen, label = "\n11 Hosts", y = 50), colour = "#955196", angle = 90, family = "Times New Roman") +
    geom_text(aes(x = segment_8_last_gen, label = "\n10 Hosts", y = 50), colour = "#955196", angle = 90, family = "Times New Roman") +
    geom_text(aes(x = segment_9_last_gen, label = "\n9 Hosts", y = 50), colour = "#955196", angle = 90, family = "Times New Roman") +
    theme_light() +
...
ar <- ggplot(combined_data, aes(x = generation, y = average_ar)) +
    geom_ribbon(aes(ymin = min_ar, ymax = max_ar), alpha = 0.2, linetype = 2, fill = "#444e86") +
    geom_line(color = "#444e86", size = 1) +
    labs(
        x = "Generation",
        y = "Acceptance Ratio"
    ) +
    ...
    geom_text(aes(x = segment_8_last_gen, label = "36 SFCRs\n", y = 0.3), colour = "#003f5c", angle = 90, family = "Times New Roman") +
    geom_text(aes(x = segment_9_last_gen, label = "40 SFCRs\n", y = 0.3), colour = "#003f5c", angle = 90, family = "Times New Roman") +
    geom_text(aes(x = 1, label = "\n14 Hosts", y = 0.3), colour = "#955196", angle = 90, family = "Times New Roman") +
    geom_text(aes(x = segment_1_last_gen, label = "\n14 Hosts", y = 0.3), colour = "#955196", angle = 90, family = "Times New Roman") +
    geom_text(aes(x = segment_2_last_gen, label = "\n14 Hosts", y = 0.3), colour = "#955196", angle = 90, family = "Times New Roman") +
    geom_text(aes(x = segment_3_last_gen, label = "\n14 Hosts", y = 0.3), colour = "#955196", angle = 90, family = "Times New Roman") +
    geom_text(aes(x = segment_4_last_gen, label = "\n14 Hosts", y = 0.3), colour = "#955196", angle = 90, family = "Times New Roman") +
    geom_text(aes(x = segment_5_last_gen, label = "\n13 Hosts", y = 0.3), colour = "#955196", angle = 90, family = "Times New Roman") +
    geom_text(aes(x = segment_6_last_gen, label = "\n12 Hosts", y = 0.3), colour = "#955196", angle = 90, family = "Times New Roman") +
    geom_text(aes(x = segment_7_last_gen, label = "\n11 Hosts", y = 0.3), colour = "#955196", angle = 90, family = "Times New Roman") +
    geom_text(aes(x = segment_8_last_gen, label = "\n10 Hosts", y = 0.3), colour = "#955196", angle = 90, family = "Times New Roman") +
    geom_text(aes(x = segment_9_last_gen, label = "\n9 Hosts", y = 0.3), colour = "#955196", angle = 90, family = "Times New Roman") +
    theme_light() +
...
ggsave("experiments/surrogate_experiments/genesis_dynamic/dynamic_plot.png", width = 12, height = 8, dpi = 300, plot = plots)
